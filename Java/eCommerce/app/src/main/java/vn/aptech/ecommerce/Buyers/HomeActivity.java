...
import vn.aptech.ecommerce.Admin.AdminMaintainProductsActivity;
import vn.aptech.ecommerce.Model.Products;
import vn.aptech.ecommerce.Prevalent.Prevalent;
import vn.aptech.ecommerce.R;
import vn.aptech.ecommerce.ViewHolder.ProductViewHolder;

public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    private DatabaseReference ProductsRef;
    private RecyclerView recyclerViewContentMain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewContentMain = findViewById(R.id.recycler_menu);
        recyclerViewContentMain.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(this);
        recyclerViewContentMain.setLayoutManager(layoutManager);
    ...
    protected void onStart() {
        ...
        recyclerViewContentMain.setAdapter(adapter);
