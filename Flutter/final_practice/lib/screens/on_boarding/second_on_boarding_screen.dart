import 'package:final_practice/blocs/tmdb_movie/trending_list_bloc/trending_event_list.dart';
...
class SecondOnBoardingScreen extends StatefulWidget {
  ...
  static const String routeName = '/second_on_boarding';
          ...
          builder: (context, state) {
            ...
            if (state is TrendingListFailState) {
              return const BackGroundOnBoardingScreenFail(
                assetImage: PathConstant.IMAGE_DEFAULT_WHEN_LOAD_IMAGE_ERROR_2,
              );
            }
            return Container();
          },
