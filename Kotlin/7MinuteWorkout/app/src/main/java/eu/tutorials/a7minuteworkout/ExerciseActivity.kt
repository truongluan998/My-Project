...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private var resTimerDuration : Long = 10
    ...
    private fun setRestProgressbar() {
        ...
        restTimer = object : CountDownTimer(resTimerDuration * 1000, 1000) {
    ...
    private fun setExerciseProgressbar() {
        ...
        exerciseTimer = object : CountDownTimer(exerciseTimeDuration * 1000, 1000) {
            override fun onTick(p0: Long) {
                ...
                tvTimerExercise.text = (exerciseTimeDuration - exerciseProgress).toString()
            }
    ...
    private fun setupRestView() {
        ...
        try {
            val soundURI =
                Uri.parse("android.resource://eu.tutorials.a7minuteworkout/" + R.raw.press_start)
