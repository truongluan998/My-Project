...
class SqliteOpenHelper(context: Context, factory: SQLiteDatabase.CursorFactory?) :
    SQLiteOpenHelper(context, DATABASE_NAME, factory, DATABASE_VERSSION) {

    companion object {
        private  val DATABASE_VERSSION = 1
        private  val DATABASE_NAME = "SevenMinutesWorkout.db"
        private  val TABLE_HISTORY = "history"
        private  val COLUMN_ID = "_id"
        private  val COLUMN_COMPLETE_DATE = "complete_date"
    ...
    override fun onUpgrade(db: SQLiteDatabase?, p1: Int, p2: Int) {
        db?.execSQL("DROP TABLE IF EXITS " + TABLE_HISTORY)
        onCreate(db)
    }
