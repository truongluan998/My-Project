...
import com.khanhpham.smartkidz.exception.FileStorageException;
import com.khanhpham.smartkidz.exception.MyFileNotFoundException;
...
public class FileStorageServiceImpl implements FileStorageService {
    ...
    public String storeFile(MultipartFile file, String username) {
        ...
        // Normalize file name
        if (username != null) {
            fileName = StringUtils.cleanPath(username + ".jpg");
        } else {
